...
namespace donely_Inspilab.Classes
{
    public class User
    {
        ...
        public DateTime? AccountCreated { get; private set; } //? = nullable
        public DateTime? LastLogin { get; private set; } //? = nullable

        private User(string _name, string _email, string _telephoneNumber, string _hashedPassword/*, profilePicture*/) //constructor register/new user
        {
            Name = _name;
            Email = _email;
